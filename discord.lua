Citizen.CreateThread(function()
    while true do
        ...
        SetDiscordAppId(setidhere) -- client id (int)
        ...
        SetDiscordRichPresenceAsset("bigpicture") -- large logo key (string)
        SetDiscordRichPresenceAssetText(GetPlayerName(source)) -- Large logo "hover" text (string)

        SetDiscordRichPresenceAssetSmall("smallpicture") -- small logo key (string)
